...
const Footer = () => {
  return (
    <>
      <footer
        className="flex justify-center wow fadeInUp dark:bg-gray-dark relative z-10 bg-white pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <h3>
                  Manufactured by MAS SPORT
                </h3>
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  Raipur , chattisgarh 492015, INDIA
                </p>
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">Phone :+91 9827356764</p>
